...
import { createOffer, updateOffer, getExpiredOffers, getPendingOffers, getRejectedOffers, getAllOffers} from "../../controllers/offer.controller.js";
...
router.route("/all-offers").get(verifyJWT(Agent), getAllOffers)
