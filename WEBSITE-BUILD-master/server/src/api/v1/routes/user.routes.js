...
import { createReservation, deleteReservation } from "../controllers/host/reservations.controller.js";
...
router.route("/update-details").patch(verifyJWT(User), updateAccountDetails)
...
router.route("/triplists").get(verifyJWT(User),getTripList)
...
router.route("/properties/category/:category").get(getPropertiesByCategories)
...
router.route("/check-auth").get(verifyJWT(User), (req, res) => {
