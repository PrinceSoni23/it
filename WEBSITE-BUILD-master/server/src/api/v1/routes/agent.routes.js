...
import { loginAgent,logoutAgent,registerAgent,refreshAccessToken, changeCurrentPassword, getCurrentAgent, updateAgentDetails, updateAgentAvatar, deleteAgent, getAllHostsByAgent, checkHostbyPhoneNumber } from "../controllers/agent.controller.js";
...
router.route("/all-hosts").get(verifyJWT(Agent), getAllHostsByAgent);
router.route("/check-host").post(verifyJWT(Agent), checkHostbyPhoneNumber);
